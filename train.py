...
parser.add_argument(
    "--coco", type=str, default="mask1_rcnn_coco.h5", help="COCO weights path"
)
parser.add_argument(
    "--layers", type=str, default="heads", help="Which layers to train (heads, all)"
)
...
model = modellib.MaskRCNN(mode="training", config=config_, model_dir=DEFAULT_LOGS_DIR)
